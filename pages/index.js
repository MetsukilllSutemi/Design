        ...
        <div className="relative">
          <div className="mx-auto max-w-4xl space-y-8 px-4">
            ...
            <div className="rounded-lg bg-white p-4 text-center sm:p-6">
              <p className="text-base leading-relaxed text-gray-700 sm:text-lg">
                ...
                элементы и т.д. могут и будут меняться. Примеры созданы только
                для выбора общего направления стиля.
              </p>
            </div>
            ...
            <div className="rounded-lg bg-white p-4 text-center sm:p-6">
              ...
              <p className="text-sm leading-relaxed text-gray-700 sm:text-base">
                ...
                функциональностью. Его черты: контрастная темная или светлая
                тема с глубокими серыми тонами и яркими акцентами (часто синий
                или фиолетовый), четкая типографика, округлость и плавные
                анимации. Стиль создает технологичный и профессиональный образ,
                делая акцент на удобстве восприятия.
              </p>
            </div>
          </div>
          ...
          <div className="min-h-screen bg-gray-950 p-8 font-sans text-gray-100">
            <div className="mx-auto max-w-6xl">
              {/* Header */}
              <header className="mb-12 flex flex-col items-center gap-4 sm:mb-16 sm:flex-row sm:items-center sm:justify-between">
                {/* Logo */}
                <div className="flex items-center gap-3">
                  <div className="flex h-10 w-10 items-center justify-center rounded-lg bg-[#0066FF] sm:h-12 sm:w-12">
                    <span className="text-lg font-bold sm:text-xl">L</span>
                  </div>
                  <span className="text-lg font-bold sm:text-xl">Logo</span>
                </div>
                  ...
                  {["Главная", "Услуги", "Проекты", "Блог", "Контакты"].map(
                    (item) => (
                      <a
                        key={item}
                        href="#"
                        className="text-sm transition-colors hover:text-[#0066FF] sm:text-base"
                      >
                        {item}
                      </a>
                    )
                ...
                {/* CTA Button */}
                <button className="w-full rounded-lg bg-[#0066FF] px-4 py-2 text-sm font-bold text-white shadow-lg shadow-blue-500/30 transition-colors hover:bg-blue-700 sm:w-auto sm:px-6 sm:py-3 sm:text-base">
                  Оставить заявку
                </button>
              </header>
              ...
              <div className="mb-24 text-center">
                <h1 className="mb-6 text-5xl font-black">
                  Здесь будет наш{" "}
                  <span className="text-[#0066FF]">заголовок</span>
                </h1>
                ...
                <div className="grid grid-cols-1 gap-8 md:grid-cols-3">
                  ...
                  <div className="rounded-lg border border-transparent bg-gray-900 p-8 transition-all duration-300">
                    ...
                    <p className="mb-6 text-gray-400">
                      ...
                      понимают с первого взгляда. Прорабатываем каждый пиксель
                      для идеального пользовательского опыта.
                    </p>
                  ...
                  <div className="rounded-lg border border-transparent bg-gray-900 p-8 transition-all duration-300 ">
                    ...
                    <p className="mb-6 text-gray-400">
                      Используем современные технологии и проверенные
                      методологии для быстрого вывода вашего продукта на рынок
                      без потери качества.
                    </p>
                    <ul className="space-y-3">
                      <li className="flex items-center gap-3">
          ...
          <div className="min-h-screen bg-white p-8 font-sans text-gray-800">
            <div className="mx-auto max-w-6xl">
              ...
              <header className="mb-12 flex flex-col items-center gap-4 sm:mb-16 sm:flex-row sm:items-center sm:justify-between">
                {/* Logo */}
                <div className="flex items-center gap-3">
                  <div className="flex h-10 w-10 items-center justify-center rounded-xl bg-[#8B5CF6] font-bold text-white sm:h-12 sm:w-12">
                    <span className="text-lg sm:text-xl">L</span>
                  </div>
                  ...
                  {["Главная", "Услуги", "Проекты", "Блог", "Контакты"].map(
                    (item) => (
                      <a
                        key={item}
                        href="#"
                        className="text-sm text-gray-900 transition-colors hover:text-[#8B5CF6] sm:text-base"
                      >
                        {item}
                      </a>
                    )
                ...
                {/* CTA Button */}
                <button className="w-full rounded-2xl bg-[#8B5CF6] px-4 py-2 text-sm font-bold text-white shadow-lg shadow-purple-500/30 transition-colors hover:bg-purple-600 sm:w-auto sm:px-6 sm:py-3 sm:text-base">
                  Оставить заявку
                </button>
              </header>
              ...
              <div className="mb-24 text-center">
                <h1 className="mb-6 text-5xl font-extrabold text-gray-900">
                  Здесь будет наш{" "}
                  <span className="text-[#8B5CF6]">заголовок</span>
                </h1>
          ...
          <div className="mx-auto max-w-4xl rounded-lg bg-white p-4 text-center sm:p-6">
            <h3 className="mb-3 text-lg font-semibold text-gray-900 sm:mb-4 sm:text-xl">
            ...
            <p className="text-sm leading-relaxed text-gray-700 sm:text-base">
              ...
              типографике с тонкими начертаниями, острых углах, обилии
              свободного пространства и лаконичных карточках с тонкими рамками.
              Плавные анимации при наведении и строгая иерархия создают
              профессиональный образ, где удобство пользователя сочетается с
              визуальной роскошью.
            </p>
          </div>
          ...
          <div className="bg-gradient-to-br from-gray-900 to-black p-8 font-sans text-white">
            <div>
              {/* Header */}
              <header className="mb-12 flex flex-col items-center gap-6 sm:mb-16 sm:flex-row sm:items-center sm:justify-between">
                {/* Logo */}
                <div className="flex items-center gap-3">
                  <div className="flex h-10 w-10 items-center justify-center rounded-lg border border-gray-700 bg-gradient-to-r from-gray-800 to-gray-900 sm:h-12 sm:w-12">
                    <span className="text-lg font-light sm:text-xl">L</span>
                  </div>
                  ...
                  {["Главная", "Услуги", "Проекты", "Блог", "Контакты"].map(
                    (item) => (
                      <a
                        key={item}
                        href="#"
                        className="text-xs tracking-widest text-gray-400 uppercase transition-all duration-300 transform hover:scale-110 hover:font-medium hover:text-gold-400 sm:text-sm"
                      >
                        {item}
                      </a>
                    )
                ...
                {/* CTA Button */}
                <button className="w-full border border-gold-500 px-4 py-3 text-xs text-gold-400 transition-all duration-300 transform hover:scale-105 hover:border-gold-300 hover:bg-gold-500/10 hover:text-gold-300 sm:w-auto sm:px-8 sm:py-4 sm:text-sm">
                  Оставить заявку
                </button>
              </header>
              ...
              <div className="mb-24 text-center">
                <h1 className="mb-4 text-4xl font-light tracking-widest">
                  Здесь будет наш{" "}
                  <span className="text-gold-400">заголовок</span>
                </h1>
                  ...
                  {[1, 2, 3].map((item) => (
                    ...
                    >
                      ...
                      <p className="mb-6 text-center text-sm leading-relaxed text-gray-400">
                        Описание услуги. Можно сразу перейти на отдельную
                        страницу с подробным описанием услуги. Элементы могут
                        располагаться как угодно и где угодно.
                      </p>
          ...
          <div className="bg-gradient-to-br from-gray-50 to-white p-8 font-sans text-gray-900">
            <div>
              ...
              <header className="mb-12 flex flex-col items-center gap-6 sm:mb-16 sm:flex-row sm:items-center sm:justify-between">
                {/* Logo */}
                <div className="flex items-center gap-3">
                  <div className="flex h-10 w-10 items-center justify-center rounded-lg border border-gray-200 bg-gradient-to-r from-white to-gray-50 shadow-sm sm:h-12 sm:w-12">
                    <span className="text-lg font-light text-gray-700 sm:text-xl">
                      L
                    </span>
                  </div>
                  <span className="text-lg font-light tracking-widest text-gray-800 sm:text-xl">
                    Logo
                  </span>
                </div>
                  ...
                  {["Главная", "Услуги", "Проекты", "Блог", "Контакты"].map(
                    (item) => (
                      <a
                        key={item}
                        href="#"
                        className="text-xs tracking-widest text-gray-600 uppercase transition-all duration-300 transform hover:scale-110 hover:font-medium hover:text-blue-600 sm:text-sm"
                      >
                        {item}
                      </a>
                    )
                ...
                {/* CTA Button */}
                <button className="w-full border-2 border-blue-500 px-4 py-3 text-xs text-blue-600 shadow-sm transition-all duration-300 transform hover:scale-105 hover:border-blue-400 hover:bg-blue-50 hover:text-blue-500 sm:w-auto sm:px-8 sm:py-4 sm:text-sm">
                  Оставить заявку
                </button>
              </header>
              ...
              <div className="mb-24 text-center">
                <h1 className="mb-4 text-4xl font-light tracking-widest text-gray-800">
                  Здесь будет наш{" "}
                  <span className="text-blue-600">заголовок</span>
                </h1>
          ...
          <div className="mx-auto max-w-4xl rounded-lg bg-white p-4 text-center sm:p-6">
            ...
            <p className="text-sm leading-relaxed text-gray-700 sm:text-base">
              ...
              минималистичная цветовая палитра с преобладанием нейтральных
              оттенков, плавные переходы между светом и тенью. В светлой теме
              используются нежные тени для создания эффекта "выступающих"
              элементов, в темной - более контрастные тени с инвертированной
              цветовой схемой. Стиль отличается современным технологичным видом
              с тактильным ощущением интерфейса, где каждый элемент кажется
              физически осязаемым.
            </p>
          </div>
          ...
          <div className="bg-neutral-100 px-8 py-16 font-sans text-neutral-900">
            <div className="mx-auto max-w-6xl">
              ...
              <header className="mb-12 flex flex-col items-center gap-6 sm:mb-16 sm:flex-row sm:items-center sm:justify-between">
                {/* Logo */}
                <div className="flex items-center gap-3">
                  <div className="flex h-10 w-10 items-center justify-center rounded-xl bg-neutral-100 shadow-[4px_4px_8px_rgba(0,0,0,0.1),-4px_-4px_8px_rgba(255,255,255,0.7)] sm:h-12 sm:w-12">
                    <span className="text-lg font-bold sm:text-xl">L</span>
                  </div>
                  <span className="text-lg font-bold sm:text-xl">Logo</span>
                </div>
                  ...
                  {["Главная", "Услуги", "Проекты", "Блог", "Контакты"].map(
                    (item) => (
                      <a
                        key={item}
                        href="#"
                        className="text-sm transition-colors hover:text-neutral-600 sm:text-base"
                      >
                        {item}
                      </a>
                    )
                ...
                {/* CTA Button */}
                <button className="w-full rounded-xl border border-neutral-900 px-4 py-3 text-sm transition-colors hover:bg-neutral-900 hover:text-white sm:w-auto sm:px-6 sm:py-3">
                  Оставить заявку
                </button>
              </header>
          ...
          <div className="bg-neutral-900 px-8 py-16 font-sans text-neutral-100">
            <div className="mx-auto max-w-6xl">
              ...
              <header className="mb-12 flex flex-col items-center gap-6 sm:mb-16 sm:flex-row sm:items-center sm:justify-between">
                {/* Logo */}
                <div className="flex items-center gap-3">
                  <div className="flex h-10 w-10 items-center justify-center rounded-xl bg-neutral-800 shadow-[4px_4px_8px_rgba(0,0,0,0.3),-4px_-4px_8px_rgba(255,255,255,0.05)] sm:h-12 sm:w-12">
                    <span className="text-lg font-bold text-neutral-100 sm:text-xl">
                      L
                    </span>
                  </div>
                  <span className="text-lg font-bold text-neutral-100 sm:text-xl">
                  ...
                  {["Главная", "Услуги", "Проекты", "Блог", "Контакты"].map(
                    (item) => (
                      <a
                        key={item}
                        href="#"
                        className="text-sm text-neutral-400 transition-colors hover:text-neutral-200 sm:text-base"
                      >
                        {item}
                      </a>
                    )
                ...
                {/* CTA Button */}
                <button className="w-full rounded-xl border border-neutral-200 px-4 py-3 text-sm text-neutral-100 transition-colors hover:bg-neutral-200 hover:text-neutral-900 sm:w-auto sm:px-6 sm:py-3">
                  Оставить заявку
                </button>
              </header>
          ...
          <div className="mx-auto max-w-4xl rounded-lg bg-white p-4 text-center sm:p-6">
            ...
            <p className="text-sm leading-relaxed text-gray-700 sm:text-base">
              Основные черты: чистая белая основа, тонкие горизонтальные
              разделители вместо карточек, сдержанная серая палитра, акцент на
              качественную типографику с четкой иерархией, минимальное
              количество декоративных элементов и упор на читабельность
              контента.
            </p>
          </div>
              ...
              <header className="mb-12 flex flex-col items-center gap-6 sm:mb-16 sm:flex-row sm:items-center sm:justify-between">
                ...
                <div className="flex items-center gap-3">
                  <div className="flex h-10 w-10 items-center justify-center sm:h-12 sm:w-12">
                    <span className="text-lg font-medium sm:text-xl">L</span>
                  </div>
                ...
                {/* CTA Button */}
                <button className="w-full bg-gray-900 px-4 py-3 text-sm text-white transition-colors hover:bg-gray-800 sm:w-auto sm:px-6 sm:py-3">
                  Оставить заявку
                </button>
              </header>
              {/* Hero Section */}
          ...
          <div className="bg-gray-900 p-8 font-sans text-gray-100">
            <div className="mx-auto max-w-6xl">
              ...
              <header className="mb-12 flex flex-col items-center gap-6 sm:mb-16 sm:flex-row sm:items-center sm:justify-between">
                ...
                <div className="flex items-center gap-3">
                  <div className="flex h-10 w-10 items-center justify-center sm:h-12 sm:w-12">
                    <span className="text-lg font-medium text-gray-100 sm:text-xl">
                      L
                    </span>
                  </div>
                  <span className="text-lg font-medium text-gray-100 sm:text-xl">
                  ...
                  {["Главная", "Услуги", "Проекты", "Блог", "Контакты"].map(
                    (item) => (
                      <a
                        key={item}
                        href="#"
                        className="text-sm text-gray-400 transition-colors hover:text-gray-200 sm:text-base"
                      >
                        {item}
                      </a>
                    )
                ...
                {/* CTA Button */}
                <button className="w-full bg-gray-100 px-4 py-3 text-sm text-gray-900 transition-colors hover:bg-gray-200 sm:w-auto sm:px-6 sm:py-3">
                  Оставить заявку
                </button>
              </header>
          ...
          <div className="mx-auto max-w-4xl rounded-lg bg-white p-4 text-center sm:p-6">
            ...
            <p className="text-sm leading-relaxed text-gray-700 sm:text-base">
              Основные черты: моноширинный шрифт, контрастная черно-белая
              цветовая схема, грубые рамки вокруг всех элементов, отсутствие
              скруглений и теней, намеренно "сырой" вид с акцентом на
          ...
          <div className="min-h-screen bg-white font-mono text-black">
            <div>
              {/* Header */}
              <header className="container mx-auto border-b border-black px-4 py-4 sm:px-6">
                <div className="flex items-center justify-between">
                  ...
                  <div className="flex items-center gap-4 sm:gap-6">
                    ...
                    {/* CTA Button */}
                    <button className="border border-black bg-black px-3 py-2 text-sm font-bold text-white transition-colors hover:bg-gray-800 sm:px-4">
                      Оставить заявку
                    </button>
                ...
                {/* Мобильная навигация (раскрывается при клике) */}
                  ...
                  {["Главная", "Услуги", "Проекты", "Блог", "Контакты"].map(
                    (item) => (
                      <a
                        key={item}
                        href="#"
                        className="border-b border-transparent px-2 py-2 text-sm font-medium transition-colors hover:border-black"
                      >
                        {item}
                      </a>
                    )
              ...
              <section className="container mx-auto px-6 py-24">
                <div className="max-w-4xl">
                  <h1 className="mb-6 text-4xl leading-tight font-black tracking-tight sm:mb-8 sm:text-5xl sm:leading-none lg:text-7xl">
                    ЗДЕСЬ
                    <br />
                    БУДЕТ НАШ
                    <br />
                    <span className="bg-black px-3 text-white sm:px-4">
                      ЗАГОЛОВОК
                    </span>
                  </h1>
                  <div className="my-12 border-t border-b border-black py-8">
                    <p className="max-w-2xl text-xl">
                      Здесь будет подзаголовок. Положение не имеет значения -
                      слева, справа, по центру. Больше текста, меньше текста.
                      Какие мы молодцы.
                    </p>
                  </div>
          ...
          <div className="min-h-screen bg-black font-mono text-white">
            <div>
              {/* Header */}
              <header className="container mx-auto border-b border-white px-4 py-4 sm:px-6">
                <div className="flex items-center justify-between">
                  {/* Logo */}
                  <div className="flex items-center gap-3">
                    <div className="text-xl font-bold tracking-tighter sm:text-2xl">
                  ...
                  <div className="flex items-center gap-4 sm:gap-6">
                    ...
                    {/* CTA Button */}
                    <button className="border border-white bg-white px-3 py-2 text-sm font-bold text-black transition-colors hover:bg-gray-200 sm:px-4">
                      Оставить заявку
                    </button>
                  ...
                  {["Главная", "Услуги", "Проекты", "Блог", "Контакты"].map(
                    (item) => (
                      <a
                        key={item}
                        href="#"
                        className="border-b border-transparent px-2 py-2 text-sm font-medium transition-colors hover:border-white"
                      >
                        {item}
                      </a>
                    )
              ...
              <section className="container mx-auto px-6 py-24">
                <div className="max-w-4xl">
                  <h1 className="mb-6 text-4xl font-black leading-tight tracking-tight sm:mb-8 sm:text-5xl sm:leading-none lg:text-7xl">
                    ЗДЕСЬ
                    <br />
                    БУДЕТ НАШ
                    <br />
                    <span className="bg-white px-3 text-black sm:px-4">
                      ЗАГОЛОВОК
                    </span>
                  </h1>
          ...
          <div className="mx-auto max-w-4xl rounded-lg bg-white p-4 text-center sm:p-6">
            ...
            <p className="text-sm leading-relaxed text-gray-700 sm:text-base">
              Основные черты: темная цветовая схема с черным фоном, синие
              акценты для интерактивных элементов, серые рамки и разделители,
              минималистичный подход с акцентом на типографику, тонкие анимации
              при наведении с синим свечением. Стиль создает впечатление
              технологичности, профессионализма и современности.
            </p>
          </div>
          ...
          <div className="bg-black font-sans text-white">
            <div>
              {/* Header */}
              <header className="border-b border-neutral-800 px-4 py-4 sm:px-6 lg:px-10 lg:py-6">
                <div className="mx-auto flex max-w-5xl items-center justify-between">
                  {/* Logo */}
                  <div className="flex items-center gap-3">
                    <div className="flex h-8 w-8 items-center justify-center border border-neutral-700 sm:h-10 sm:w-10">
                      <span className="text-base font-bold sm:text-lg">L</span>
                    </div>
                    <span className="text-base font-bold sm:text-lg">Logo</span>
                  </div>

                  {/* Navigation + CTA Button */}
                  <div className="flex items-center gap-4 sm:gap-6 lg:gap-8">
                    {/* Navigation - скрыто на мобильных */}
                    <nav className="hidden gap-4 sm:gap-6 lg:flex lg:gap-8">
                      {["Главная", "Услуги", "Проекты", "Блог", "Контакты"].map(
                        (item) => (
                          <a
                            key={item}
                    ...
                    {/* CTA Button */}
                    <button className="border border-blue-500 px-3 py-1.5 text-xs text-blue-500 transition hover:bg-blue-500 hover:text-white sm:px-4 sm:py-2 sm:text-sm lg:px-5">
                      Оставить заявку
                    </button>
                    ...
                    <button className="lg:hidden">
                      {/* Иконка бургер-меню */}
                      <div className="space-y-1">
                        <div className="h-0.5 w-6 bg-neutral-400"></div>
                        <div className="h-0.5 w-6 bg-neutral-400"></div>
                        <div className="h-0.5 w-6 bg-neutral-400"></div>
                      </div>
                    </button>
                ...
                {/* Мобильная навигация (раскрывается при клике) */}
                <nav className="mx-auto mt-4 flex max-w-5xl flex-col gap-3 lg:hidden">
                  {["Главная", "Услуги", "Проекты", "Блог", "Контакты"].map(
                    (item) => (
                      <a
                        key={item}
                        href="#"
                        className="px-2 py-2 text-sm transition-colors hover:text-blue-500"
                      >
                        {item}
                      </a>
                    )
              ...
              <section className="border-b border-neutral-800 px-10 py-32">
                <div className="mx-auto max-w-5xl text-center">
                  <h1 className="mb-6 text-5xl font-bold tracking-tight md:text-6xl">
                    Здесь будет наш{" "}
                    <span className="text-blue-500">заголовок</span>
                  </h1>
                ...
                <div className="mx-auto max-w-5xl">
                  ...
                  <div className="grid gap-6 md:grid-cols-3">
                    ...
                    <div className="border border-neutral-700 p-8 ">
                      ...
                      <p className="mb-6 text-sm text-neutral-400">
                        Ваш сайт будет идеально выглядеть на любом устройстве —
                        от смартфона до десктопа. Mobile-first подход и
          ...
          <div className="bg-white font-sans text-gray-900">
            <div>
              {/* Header */}
              <header className="border-b border-gray-200 px-4 py-4 sm:px-6 lg:px-10 lg:py-6">
                <div className="mx-auto flex max-w-5xl items-center justify-between">
                  {/* Logo */}
                  <div className="flex items-center gap-3">
                    <div className="flex h-8 w-8 items-center justify-center border border-gray-300 sm:h-10 sm:w-10">
                      <span className="text-base font-bold sm:text-lg">L</span>
                    </div>
                    <span className="text-base font-bold sm:text-lg">Logo</span>
                  </div>
                  ...
                  <div className="flex items-center gap-4 sm:gap-6 lg:gap-8">
                    ...
                    {/* CTA Button */}
                    <button className="border border-blue-600 px-3 py-1.5 text-xs text-blue-600 transition hover:bg-blue-600 hover:text-white sm:px-4 sm:py-2 sm:text-sm lg:px-5">
                      Оставить заявку
                    </button>
                  ...
                  {["Главная", "Услуги", "Проекты", "Блог", "Контакты"].map(
                    (item) => (
                      <a
                        key={item}
                        href="#"
                        className="px-2 py-2 text-sm transition-colors hover:text-blue-600"
                      >
                        {item}
                      </a>
                    )
          ...
          <div className="mx-auto max-w-4xl rounded-lg bg-white p-4 text-center sm:p-6">
            ...
            <p className="text-sm leading-relaxed text-gray-700 sm:text-base">
              Был особенно популярен в 2020-2022 годах, сейчас сохраняет
              умеренную популярность. Основные черты стиля - это
              полупрозрачность с размытием фона, создающая эффект матового
              стекла, градиентные фоновые подложки, тонкие полупрозрачные
              границы и насыщенные цветовые акценты (чаще всего фиолетовые или
              пурпурные). Стиль характеризуется большой скругленностью углов
              элементов, минималистичной типографикой с жирными шрифтами и общей
              легкостью визуального восприятия за счет прозрачностей и размытий.
            </p>
          </div>
          ...
          <div className="min-h-screen bg-gradient-to-br from-purple-900 via-gray-900 to-gray-800 font-sans text-white">
            <div>
              ...
              <header className="container mx-auto px-4 py-4 sm:px-6 sm:py-6">
                <div className="flex items-center justify-between rounded-2xl border border-white/10 bg-white/5 px-4 py-3 backdrop-blur-md sm:px-6 sm:py-4">
                  {/* Logo */}
                  <div className="flex items-center gap-3">
                    <div className="flex h-8 w-8 items-center justify-center rounded-xl border border-white/20 bg-white/10 sm:h-10 sm:w-10">
                      <span className="text-lg font-black sm:text-xl">L</span>
                    </div>
                    <span className="text-xl font-black sm:text-2xl">Logo</span>
                  </div>

                  {/* Navigation + CTA Button */}
                  <div className="flex items-center gap-4 sm:gap-6">
                    {/* Navigation - скрыто на мобильных */}
                    <nav className="hidden space-x-6 md:flex md:space-x-8">
                      {["Главная", "Услуги", "Проекты", "Блог", "Контакты"].map(
                        (item) => (
                          <a
                            key={item}
                            href="#"
                            className="text-sm font-medium transition-colors hover:text-purple-300 sm:text-base"
                          >
                            {item}
                          </a>
                        )
                    ...
                    {/* CTA Button */}
                    <button className="rounded-xl border border-purple-400/30 bg-purple-600/20 px-4 py-1.5 text-sm font-semibold backdrop-blur-md transition-colors hover:bg-purple-600/30 sm:px-6 sm:py-2">
                      Оставить заявку
                    </button>
                ...
                {/* Мобильная навигация (раскрывается при клике) */}
                <nav className="mt-4 flex flex-col space-y-3 rounded-2xl border border-white/10 bg-white/5 px-4 py-4 backdrop-blur-md md:hidden">
                  {["Главная", "Услуги", "Проекты", "Блог", "Контакты"].map(
                    (item) => (
                      <a
                        key={item}
                        href="#"
                        className="px-3 py-2 text-sm font-medium transition-colors hover:text-purple-300"
                      >
                        {item}
                      </a>
                    )
          ...
          <div className="min-h-screen bg-gradient-to-br from-purple-50 via-white to-gray-100 font-sans text-gray-900">
            <div>
              {/* Header */}
              <header className="container mx-auto px-4 py-4 sm:px-6 sm:py-6">
                <div className="flex items-center justify-between rounded-2xl border border-gray-200 bg-white/80 px-4 py-3 backdrop-blur-md shadow-lg sm:px-6 sm:py-4">
                  {/* Logo */}
                  <div className="flex items-center gap-3">
                    <div className="flex h-8 w-8 items-center justify-center rounded-xl border border-purple-200 bg-purple-50 sm:h-10 sm:w-10">
                      <span className="text-lg font-black text-purple-600 sm:text-xl">
                        L
                      </span>
                    </div>
                  ...
                  <div className="flex items-center gap-4 sm:gap-6">
                      ...
                      {["Главная", "Услуги", "Проекты", "Блог", "Контакты"].map(
                        (item) => (
                          <a
                            key={item}
                            href="#"
                            className="text-sm font-medium text-gray-600 transition-colors hover:text-purple-600 sm:text-base"
                          >
                            {item}
                          </a>
                        )
                    ...
                    {/* CTA Button */}
                    <button className="rounded-xl border border-purple-300 bg-purple-500 px-4 py-1.5 text-sm font-semibold text-white shadow-md backdrop-blur-md transition-colors hover:bg-purple-600 sm:px-6 sm:py-2">
                      Оставить заявку
                    </button>
                ...
                {/* Мобильная навигация (раскрывается при клике) */}
                <nav className="mt-4 flex flex-col space-y-3 rounded-2xl border border-gray-200 bg-white/80 px-4 py-4 backdrop-blur-md shadow-lg md:hidden">
                  {["Главная", "Услуги", "Проекты", "Блог", "Контакты"].map(
                    (item) => (
                      <a
                        key={item}
                        href="#"
                        className="px-3 py-2 text-sm font-medium text-gray-600 transition-colors hover:text-purple-600"
                      >
                        {item}
                      </a>
                    )
          ...
          <div className="bg-neutral-950 px-10 py-20 font-sans text-neutral-100">
            <div className="mx-auto max-w-6xl">
              ...
              <header className="mb-12 flex flex-col items-center gap-6 sm:mb-16 sm:flex-row sm:items-center sm:justify-between">
                {/* Logo */}
                <div className="flex items-center gap-3">
                  <div className="flex h-10 w-10 items-center justify-center rounded-xl border border-neutral-800 bg-neutral-900 sm:h-12 sm:w-12">
                    <span className="text-lg font-bold sm:text-xl">L</span>
                  </div>
                  ...
                  {["Главная", "Услуги", "Проекты", "Блог", "Контакты"].map(
                    (item) => (
                      <a
                        key={item}
                        href="#"
                        className="text-sm transition-colors hover:text-violet-400 sm:text-base"
                      >
                        {item}
                      </a>
                    )
                ...
                {/* CTA Button */}
                <button className="w-full rounded border border-violet-400 px-4 py-3 text-sm font-medium text-violet-400 transition hover:bg-violet-500 hover:text-white sm:w-auto sm:px-6 sm:py-3">
                  Оставить заявку
                </button>
              </header>
              ...
              <section className="mb-24">
                ...
                <p className="mb-10 max-w-2xl text-neutral-400">
                  Мы объединяем технологии и эстетику. Минимализм, код,
                  точность.
                </p>
                <div className="grid gap-8 md:grid-cols-3">
                  {[1, 2, 3].map((item) => (
          ...
          <div className="bg-neutral-50 font-sans text-neutral-900">
            <div className="mx-auto max-w-6xl px-10 py-20">
              ...
              <header className="mb-12 flex flex-col items-center gap-6 sm:mb-16 sm:flex-row sm:items-center sm:justify-between">
                {/* Logo */}
                <div className="flex items-center gap-3">
                  <div className="flex h-10 w-10 items-center justify-center rounded-lg border border-neutral-200 bg-white shadow-sm sm:h-12 sm:w-12">
                    <span className="text-lg font-bold sm:text-xl">L</span>
                  </div>
                  <span className="text-lg font-bold sm:text-xl">Logo</span>
                </div>
                  ...
                  {["Главная", "Услуги", "Проекты", "Блог", "Контакты"].map(
                    (item) => (
                      <a
                        key={item}
                        href="#"
                        className="text-sm transition-colors hover:text-blue-600 sm:text-base"
                      >
                        {item}
                      </a>
                    )
                ...
                {/* CTA Button */}
                <button className="w-full rounded border border-blue-600 px-4 py-3 text-sm font-medium text-blue-600 transition hover:bg-blue-600 hover:text-white sm:w-auto sm:px-6 sm:py-3">
                  Оставить заявку
                </button>
              </header>
              {/* Hero Section */}
